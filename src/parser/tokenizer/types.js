...
export const types = {
  ...
  arrowThin: new TokenType('->', { beforeExpr }),
  ...
  round: new TokenType('~', { beforeExpr, prefix, startsExpr }),
  truncate: new TokenType('~~', { beforeExpr, prefix, startsExpr }),
  ...
  plusMin: new TokenType('+/-', {
    beforeExpr, binop: 9, prefix, startsExpr
  }),
...
export const keywords = {
  ...
  await: new KeywordTokenType('await', { beforeExpr, startsExpr }),
  cond: new KeywordTokenType('cond', { startsExpr })
};
